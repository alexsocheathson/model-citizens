  ...
  <div class="landing">
    <div class= "grid-container">
      <div class= "grid-x">
        ...
        <h1 class= "cell small-12 title animated fadeInDown delay-1s">Model Citizens</h1>
        <p class= "cell small-12 project-members">Abe Casey, Lief Jorgensen, Alex Son, Brodie Theide, Jack Welsh</p>
